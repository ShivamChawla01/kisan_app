...
{\color{incolor}In [{\color{incolor}1}]:} \PY{c+c1}{\PYZsh{} Load pickled data}
        ...
        \PY{n}{training\PYZus{}file} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{C:}\PY{l+s+se}{\PYZbs{}\PYZbs{}}\PY{l+s+s1}{Users}\PY{l+s+se}{\PYZbs{}\PYZbs{}}\PY{l+s+s1}{Shivam.Chawla01}\PY{l+s+se}{\PYZbs{}\PYZbs{}}\PY{l+s+s1}{CarND\PYZhy{}Traffic\PYZhy{}Sign\PYZhy{}Classifier\PYZhy{}Project}\PY{l+s+se}{\PYZbs{}\PYZbs{}}\PY{l+s+s1}{traffic\PYZhy{}signs\PYZhy{}data}\PY{l+s+se}{\PYZbs{}\PYZbs{}}\PY{l+s+s1}{train.p}\PY{l+s+s1}{\PYZsq{}}
        \PY{n}{validation\PYZus{}file}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{C:}\PY{l+s+se}{\PYZbs{}\PYZbs{}}\PY{l+s+s1}{Users}\PY{l+s+se}{\PYZbs{}\PYZbs{}}\PY{l+s+s1}{Shivam.Chawla01}\PY{l+s+se}{\PYZbs{}\PYZbs{}}\PY{l+s+s1}{CarND\PYZhy{}Traffic\PYZhy{}Sign\PYZhy{}Classifier\PYZhy{}Project}\PY{l+s+se}{\PYZbs{}\PYZbs{}}\PY{l+s+s1}{traffic\PYZhy{}signs\PYZhy{}data}\PY{l+s+se}{\PYZbs{}\PYZbs{}}\PY{l+s+s1}{valid.p}\PY{l+s+s1}{\PYZsq{}}
        \PY{n}{testing\PYZus{}file} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{C:}\PY{l+s+se}{\PYZbs{}\PYZbs{}}\PY{l+s+s1}{Users}\PY{l+s+se}{\PYZbs{}\PYZbs{}}\PY{l+s+s1}{Shivam.Chawla01}\PY{l+s+se}{\PYZbs{}\PYZbs{}}\PY{l+s+s1}{CarND\PYZhy{}Traffic\PYZhy{}Sign\PYZhy{}Classifier\PYZhy{}Project}\PY{l+s+se}{\PYZbs{}\PYZbs{}}\PY{l+s+s1}{traffic\PYZhy{}signs\PYZhy{}data}\PY{l+s+se}{\PYZbs{}\PYZbs{}}\PY{l+s+s1}{test.p}\PY{l+s+s1}{\PYZsq{}}
...
{\color{incolor}In [{\color{incolor}2}]:} \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} Replace each question mark with the appropriate value. }
        ...
        \PY{n}{n\PYZus{}classes} \PY{o}{=} \PY{n+nb}{len}\PY{p}{(}\PY{n}{y\PYZus{}valid}\PY{p}{)}
...
{\color{incolor}In [{\color{incolor}3}]:} \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} Data exploration visualization code goes here.}
        ...
        \PY{n}{y}\PY{p}{,} \PY{n}{x} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{histogram}\PY{p}{(}\PY{n}{y\PYZus{}train}\PY{p}{,} \PY{n}{bins}\PY{o}{=}\PY{n}{n\PYZus{}classes}\PY{p}{)}
        \PY{n}{fig}\PY{p}{,} \PY{n}{ax} \PY{o}{=} \PY{n}{plt}\PY{o}{.}\PY{n}{subplots}\PY{p}{(}\PY{p}{)}
        \PY{n}{ax}\PY{o}{.}\PY{n}{plot}\PY{p}{(}\PY{n}{x}\PY{p}{[}\PY{p}{:}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{,} \PY{n}{y}\PY{p}{)}
        \PY{n}{ax}\PY{o}{.}\PY{n}{set\PYZus{}title}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{training labels v/s number of output classes}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
        
        
        \PY{n}{y}\PY{p}{,} \PY{n}{x} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{histogram}\PY{p}{(}\PY{n}{y\PYZus{}valid}\PY{p}{,} \PY{n}{bins}\PY{o}{=}\PY{n}{n\PYZus{}classes}\PY{p}{)}
        \PY{n}{fig}\PY{p}{,} \PY{n}{ax} \PY{o}{=} \PY{n}{plt}\PY{o}{.}\PY{n}{subplots}\PY{p}{(}\PY{p}{)}
        \PY{n}{ax}\PY{o}{.}\PY{n}{plot}\PY{p}{(}\PY{n}{x}\PY{p}{[}\PY{p}{:}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{,} \PY{n}{y}\PY{p}{)}
        \PY{n}{ax}\PY{o}{.}\PY{n}{set\PYZus{}title}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{validation labels v/s number of output classes}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
        
        
        \PY{n}{y}\PY{p}{,} \PY{n}{x} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{histogram}\PY{p}{(}\PY{n}{y\PYZus{}test}\PY{p}{,} \PY{n}{bins}\PY{o}{=}\PY{n}{n\PYZus{}classes}\PY{p}{)}
        \PY{n}{fig}\PY{p}{,} \PY{n}{ax} \PY{o}{=} \PY{n}{plt}\PY{o}{.}\PY{n}{subplots}\PY{p}{(}\PY{p}{)}
        \PY{n}{ax}\PY{o}{.}\PY{n}{plot}\PY{p}{(}\PY{n}{x}\PY{p}{[}\PY{p}{:}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{,} \PY{n}{y}\PY{p}{)}
        \PY{n}{ax}\PY{o}{.}\PY{n}{set\PYZus{}title}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{test labels v/s number of output classes}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
\end{Verbatim}
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}3}]:} <matplotlib.text.Text at 0x20f84ec8668>
\end{Verbatim}
...
{\color{incolor}In [{\color{incolor}4}]:} \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} Preprocess the data here. It is required to normalize the data. Other preprocessing steps could include }
        ...
        \PY{n}{X\PYZus{}train}\PY{o}{=}\PY{n}{np}\PY{o}{.}\PY{n}{average}\PY{p}{(}\PY{n}{X\PYZus{}train}\PY{p}{,}\PY{n}{axis}\PY{o}{=}\PY{l+m+mi}{3}\PY{p}{,}\PY{n}{weights}\PY{o}{=}\PY{p}{[}\PY{l+m+mf}{0.299}\PY{p}{,}\PY{l+m+mf}{0.587}\PY{p}{,}\PY{l+m+mf}{0.114}\PY{p}{]}\PY{p}{)}
        \PY{n}{X\PYZus{}valid}\PY{o}{=}\PY{n}{np}\PY{o}{.}\PY{n}{average}\PY{p}{(}\PY{n}{X\PYZus{}valid}\PY{p}{,}\PY{n}{axis}\PY{o}{=}\PY{l+m+mi}{3}\PY{p}{,}\PY{n}{weights}\PY{o}{=}\PY{p}{[}\PY{l+m+mf}{0.299}\PY{p}{,}\PY{l+m+mf}{0.587}\PY{p}{,}\PY{l+m+mf}{0.114}\PY{p}{]}\PY{p}{)}
        \PY{n}{X\PYZus{}test}\PY{o}{=}\PY{n}{np}\PY{o}{.}\PY{n}{average}\PY{p}{(}\PY{n}{X\PYZus{}test}\PY{p}{,}\PY{n}{axis}\PY{o}{=}\PY{l+m+mi}{3}\PY{p}{,}\PY{n}{weights}\PY{o}{=}\PY{p}{[}\PY{l+m+mf}{0.299}\PY{p}{,}\PY{l+m+mf}{0.587}\PY{p}{,}\PY{l+m+mf}{0.114}\PY{p}{]}\PY{p}{)}
        
        
        
        \PY{n}{X\PYZus{}train}\PY{o}{=}\PY{p}{(}\PY{n}{X\PYZus{}train}\PY{o}{\PYZhy{}}\PY{l+m+mi}{128}\PY{p}{)}\PY{o}{/}\PY{l+m+mi}{128}
        \PY{n}{X\PYZus{}valid}\PY{o}{=}\PY{p}{(}\PY{n}{X\PYZus{}valid}\PY{o}{\PYZhy{}}\PY{l+m+mi}{128}\PY{p}{)}\PY{o}{/}\PY{l+m+mi}{128}
        \PY{n}{X\PYZus{}test}\PY{o}{=}\PY{p}{(}\PY{n}{X\PYZus{}test}\PY{o}{\PYZhy{}}\PY{l+m+mi}{128}\PY{p}{)}\PY{o}{/}\PY{l+m+mi}{128}
        \PY{n}{X\PYZus{}train}\PY{o}{=}\PY{n}{X\PYZus{}train}\PY{o}{.}\PY{n}{reshape}\PY{p}{(}\PY{n}{n\PYZus{}train}\PY{p}{,} \PY{l+m+mi}{32}\PY{p}{,} \PY{l+m+mi}{32}\PY{p}{,}\PY{l+m+mi}{1}\PY{p}{)}
        \PY{n}{X\PYZus{}test}\PY{o}{=}\PY{n}{X\PYZus{}test}\PY{o}{.}\PY{n}{reshape}\PY{p}{(}\PY{n}{n\PYZus{}test}\PY{p}{,} \PY{l+m+mi}{32}\PY{p}{,} \PY{l+m+mi}{32}\PY{p}{,}\PY{l+m+mi}{1}\PY{p}{)}
        \PY{n}{X\PYZus{}valid}\PY{o}{=}\PY{n}{X\PYZus{}valid}\PY{o}{.}\PY{n}{reshape}\PY{p}{(}\PY{n}{n\PYZus{}validation}\PY{p}{,} \PY{l+m+mi}{32}\PY{p}{,} \PY{l+m+mi}{32}\PY{p}{,}\PY{l+m+mi}{1}\PY{p}{)}
        
        \PY{c+c1}{\PYZsh{}X\PYZus{}train,X\PYZus{}validation,y\PYZus{}train,y\PYZus{}validation=train\PYZus{}test\PYZus{}split(X\PYZus{}train,y\PYZus{}train,test\PYZus{}size=0.2,random\PYZus{}state=0)}
\end{Verbatim}
...
{\color{incolor}In [{\color{incolor}5}]:} \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} Define your architecture here.}
        ...
        \PY{k}{def} \PY{n+nf}{LeNet}\PY{p}{(}\PY{n}{x}\PY{p}{)}\PY{p}{:}    
            ...
            \PY{c+c1}{\PYZsh{}keep\PYZus{}prob=0.6}
            \PY{c+c1}{\PYZsh{} TODO: Layer 1: Convolutional. Input = 32x32x1. Output = 28x28x6.}
            \PY{n}{conv1\PYZus{}W}\PY{o}{=}\PY{n}{tf}\PY{o}{.}\PY{n}{Variable}\PY{p}{(}\PY{n}{tf}\PY{o}{.}\PY{n}{truncated\PYZus{}normal}\PY{p}{(}\PY{p}{[}\PY{l+m+mi}{5}\PY{p}{,}\PY{l+m+mi}{5}\PY{p}{,}\PY{l+m+mi}{1}\PY{p}{,}\PY{l+m+mi}{6}\PY{p}{]}\PY{p}{,}\PY{n}{mean}\PY{o}{=}\PY{n}{mu}\PY{p}{,}\PY{n}{stddev}\PY{o}{=}\PY{n}{sigma}\PY{p}{)}\PY{p}{)}
            \PY{n}{conv1\PYZus{}B}\PY{o}{=}\PY{n}{tf}\PY{o}{.}\PY{n}{Variable}\PY{p}{(}\PY{n}{tf}\PY{o}{.}\PY{n}{zeros}\PY{p}{(}\PY{p}{[}\PY{l+m+mi}{6}\PY{p}{]}\PY{p}{)}\PY{p}{)}
            \PY{n}{conv1}\PY{o}{=}\PY{n}{tf}\PY{o}{.}\PY{n}{nn}\PY{o}{.}\PY{n}{conv2d}\PY{p}{(}\PY{n}{x}\PY{p}{,}\PY{n}{conv1\PYZus{}W}\PY{p}{,}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{,}\PY{l+m+mi}{1}\PY{p}{,}\PY{l+m+mi}{1}\PY{p}{,}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{,}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{VALID}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}\PY{o}{+}\PY{n}{conv1\PYZus{}B}
            ...
            \PY{n}{conv1}\PY{o}{=}\PY{n}{tf}\PY{o}{.}\PY{n}{nn}\PY{o}{.}\PY{n}{max\PYZus{}pool}\PY{p}{(}\PY{n}{conv1}\PY{p}{,}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{,}\PY{l+m+mi}{2}\PY{p}{,}\PY{l+m+mi}{2}\PY{p}{,}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{,}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{,}\PY{l+m+mi}{2}\PY{p}{,}\PY{l+m+mi}{2}\PY{p}{,}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{,}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{VALID}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
        
            \PY{c+c1}{\PYZsh{} TODO: Layer 2: Convolutional. Output = 10x10x16.}
            \PY{n}{conv2\PYZus{}W}\PY{o}{=}\PY{n}{tf}\PY{o}{.}\PY{n}{Variable}\PY{p}{(}\PY{n}{tf}\PY{o}{.}\PY{n}{truncated\PYZus{}normal}\PY{p}{(}\PY{p}{[}\PY{l+m+mi}{5}\PY{p}{,}\PY{l+m+mi}{5}\PY{p}{,}\PY{l+m+mi}{6}\PY{p}{,}\PY{l+m+mi}{16}\PY{p}{]}\PY{p}{,}\PY{n}{mean}\PY{o}{=}\PY{n}{mu}\PY{p}{,}\PY{n}{stddev}\PY{o}{=}\PY{n}{sigma}\PY{p}{)}\PY{p}{)}
            \PY{n}{conv2\PYZus{}B}\PY{o}{=}\PY{n}{tf}\PY{o}{.}\PY{n}{Variable}\PY{p}{(}\PY{n}{tf}\PY{o}{.}\PY{n}{zeros}\PY{p}{(}\PY{p}{[}\PY{l+m+mi}{16}\PY{p}{]}\PY{p}{)}\PY{p}{)}
            \PY{n}{conv2}\PY{o}{=}\PY{n}{tf}\PY{o}{.}\PY{n}{nn}\PY{o}{.}\PY{n}{conv2d}\PY{p}{(}\PY{n}{conv1}\PY{p}{,}\PY{n}{conv2\PYZus{}W}\PY{p}{,}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{,}\PY{l+m+mi}{1}\PY{p}{,}\PY{l+m+mi}{1}\PY{p}{,}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{,}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{VALID}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}\PY{o}{+}\PY{n}{conv2\PYZus{}B}
            ...
            \PY{n}{conv2}\PY{o}{=}\PY{n}{tf}\PY{o}{.}\PY{n}{nn}\PY{o}{.}\PY{n}{max\PYZus{}pool}\PY{p}{(}\PY{n}{conv2}\PY{p}{,}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{,}\PY{l+m+mi}{2}\PY{p}{,}\PY{l+m+mi}{2}\PY{p}{,}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{,}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{,}\PY{l+m+mi}{2}\PY{p}{,}\PY{l+m+mi}{2}\PY{p}{,}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{,}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{VALID}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
            ...
            \PY{n}{fc2}\PY{o}{=}\PY{n}{tf}\PY{o}{.}\PY{n}{nn}\PY{o}{.}\PY{n}{dropout}\PY{p}{(}\PY{n}{fc2}\PY{p}{,}\PY{n}{keep\PYZus{}prob}\PY{p}{)}
             ...
             \PY{c+c1}{\PYZsh{} TODO: Layer 5: Fully Connected. Input = 84. Output = 10.}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}7}]:} \PY{n}{rate} \PY{o}{=} \PY{l+m+mf}{0.00098}
...
{\color{incolor}In [{\color{incolor}8}]:} \PY{n}{correct\PYZus{}prediction} \PY{o}{=} \PY{n}{tf}\PY{o}{.}\PY{n}{equal}\PY{p}{(}\PY{n}{tf}\PY{o}{.}\PY{n}{argmax}\PY{p}{(}\PY{n}{logits}\PY{p}{,} \PY{l+m+mi}{1}\PY{p}{)}\PY{p}{,} \PY{n}{tf}\PY{o}{.}\PY{n}{argmax}\PY{p}{(}\PY{n}{one\PYZus{}hot\PYZus{}y}\PY{p}{,} \PY{l+m+mi}{1}\PY{p}{)}\PY{p}{)}
        ...
        \PY{k}{def} \PY{n+nf}{evaluate}\PY{p}{(}\PY{n}{X\PYZus{}data}\PY{p}{,} \PY{n}{y\PYZus{}data}\PY{p}{)}\PY{p}{:}
            ...
            \PY{c+c1}{\PYZsh{}loss\PYZus{}accuracy = 0}
            ...
            \PY{k}{for} \PY{n}{offset} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{l+m+mi}{0}\PY{p}{,} \PY{n}{num\PYZus{}examples}\PY{p}{,} \PY{n}{BATCH\PYZus{}SIZE}\PY{p}{)}\PY{p}{:}
                ...
                \PY{c+c1}{\PYZsh{}loss=sess.run(loss\PYZus{}operation, feed\PYZus{}dict=\PYZob{}x: batch\PYZus{}x, y: batch\PYZus{}y\PYZcb{})}
                \PY{n}{total\PYZus{}accuracy} \PY{o}{+}\PY{o}{=} \PY{p}{(}\PY{n}{accuracy} \PY{o}{*} \PY{n+nb}{len}\PY{p}{(}\PY{n}{batch\PYZus{}x}\PY{p}{)}\PY{p}{)}
                \PY{c+c1}{\PYZsh{}loss\PYZus{}accuracy += (loss * len(batch\PYZus{}x))}
...
{\color{incolor}In [{\color{incolor}9}]:} \PY{k}{with} \PY{n}{tf}\PY{o}{.}\PY{n}{Session}\PY{p}{(}\PY{p}{)} \PY{k}{as} \PY{n}{sess}\PY{p}{:}
            ...
            \PY{k}{for} \PY{n}{i} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n}{EPOCHS}\PY{p}{)}\PY{p}{:}
                ...
                \PY{k}{for} \PY{n}{offset} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{l+m+mi}{0}\PY{p}{,} \PY{n}{num\PYZus{}examples}\PY{p}{,} \PY{n}{BATCH\PYZus{}SIZE}\PY{p}{)}\PY{p}{:}
                    ...
                    \PY{n}{sess}\PY{o}{.}\PY{n}{run}\PY{p}{(}\PY{n}{training\PYZus{}operation}\PY{p}{,} \PY{n}{feed\PYZus{}dict}\PY{o}{=}\PY{p}{\PYZob{}}\PY{n}{x}\PY{p}{:} \PY{n}{batch\PYZus{}x}\PY{p}{,} \PY{n}{y}\PY{p}{:} \PY{n}{batch\PYZus{}y}\PY{p}{,}\PY{n}{keep\PYZus{}prob}\PY{p}{:}\PY{l+m+mf}{0.6}\PY{p}{\PYZcb{}}\PY{p}{)}
                ...
                \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Train Accuracy = }\PY{l+s+si}{\PYZob{}:.3f\PYZcb{}}\PY{l+s+s2}{\PYZdq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{training\PYZus{}accuracy}\PY{p}{)}\PY{p}{)}
...
{\color{incolor}In [{\color{incolor}11}]:} \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} Load the images and plot them here.}
         ...
         \PY{n}{image\PYZus{}labels}\PY{o}{=}\PY{p}{[}\PY{l+m+mi}{18}\PY{p}{,}\PY{l+m+mi}{17}\PY{p}{,}\PY{l+m+mi}{1}\PY{p}{,}\PY{l+m+mi}{4}\PY{p}{,}\PY{l+m+mi}{14}\PY{p}{]}
         \PY{n}{path}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{C:}\PY{l+s+se}{\PYZbs{}\PYZbs{}}\PY{l+s+s1}{Users}\PY{l+s+se}{\PYZbs{}\PYZbs{}}\PY{l+s+s1}{Shivam.Chawla01}\PY{l+s+se}{\PYZbs{}\PYZbs{}}\PY{l+s+s1}{CarND\PYZhy{}Traffic\PYZhy{}Sign\PYZhy{}Classifier\PYZhy{}Project}\PY{l+s+se}{\PYZbs{}\PYZbs{}}\PY{l+s+s1}{traffic signs}\PY{l+s+se}{\PYZbs{}\PYZbs{}}\PY{l+s+s1}{\PYZsq{}}
         \PY{k}{for} \PY{n}{image} \PY{o+ow}{in} \PY{n}{os}\PY{o}{.}\PY{n}{listdir}\PY{p}{(}\PY{n}{path}\PY{p}{)}\PY{p}{:}
             \PY{n+nb}{print}\PY{p}{(}\PY{n}{image}\PY{p}{)}
             \PY{n}{image\PYZus{}path}\PY{o}{=}\PY{n}{cv2}\PY{o}{.}\PY{n}{imread}\PY{p}{(}\PY{n}{path}\PY{o}{+}\PY{n}{image}\PY{p}{)}
             \PY{n}{image}\PY{o}{=}\PY{n}{cv2}\PY{o}{.}\PY{n}{resize}\PY{p}{(}\PY{n}{image\PYZus{}path}\PY{p}{,}\PY{p}{(}\PY{l+m+mi}{32}\PY{p}{,}\PY{l+m+mi}{32}\PY{p}{)}\PY{p}{)}
         ...
         \PY{n}{test\PYZus{}image\PYZus{}array}\PY{o}{=}\PY{n}{np}\PY{o}{.}\PY{n}{array}\PY{p}{(}\PY{n}{test\PYZus{}images}\PY{p}{)}
\end{Verbatim}
...
Image}\label{predict-the-sign-type-for-each-image}}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}12}]:} \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} Run the predictions here and use the model to output the prediction for each image.}
         ...
         \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} Feel free to use as many code cells as needed.}
         \PY{n}{test\PYZus{}image\PYZus{}array}\PY{o}{=}\PY{n}{np}\PY{o}{.}\PY{n}{average}\PY{p}{(}\PY{n}{test\PYZus{}image\PYZus{}array}\PY{p}{,}\PY{n}{axis}\PY{o}{=}\PY{l+m+mi}{3}\PY{p}{,}\PY{n}{weights}\PY{o}{=}\PY{p}{[}\PY{l+m+mf}{0.299}\PY{p}{,}\PY{l+m+mf}{0.587}\PY{p}{,}\PY{l+m+mf}{0.114}\PY{p}{]}\PY{p}{)}
         \PY{n}{test\PYZus{}image\PYZus{}array}\PY{o}{=}\PY{p}{(}\PY{n}{test\PYZus{}image\PYZus{}array}\PY{o}{\PYZhy{}}\PY{l+m+mi}{128}\PY{p}{)}\PY{o}{/}\PY{l+m+mi}{128}
         \PY{n}{test\PYZus{}image\PYZus{}array}\PY{o}{=}\PY{n}{np}\PY{o}{.}\PY{n}{reshape}\PY{p}{(}\PY{n}{test\PYZus{}image\PYZus{}array}\PY{p}{,}\PY{p}{(}\PY{l+m+mi}{5}\PY{p}{,}\PY{l+m+mi}{32}\PY{p}{,}\PY{l+m+mi}{32}\PY{p}{,}\PY{l+m+mi}{1}\PY{p}{)}\PY{p}{)}
\end{Verbatim}
...
\subsubsection{Analyze Performance}\label{analyze-performance}}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}13}]:} \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} Calculate the accuracy for these 5 new images. }
         ...
         \PY{k}{with} \PY{n}{tf}\PY{o}{.}\PY{n}{Session}\PY{p}{(}\PY{p}{)} \PY{k}{as} \PY{n}{sess}\PY{p}{:}
             \PY{n}{sess}\PY{o}{.}\PY{n}{run}\PY{p}{(}\PY{n}{tf}\PY{o}{.}\PY{n}{global\PYZus{}variables\PYZus{}initializer}\PY{p}{(}\PY{p}{)}\PY{p}{)}
             \PY{n}{saver\PYZus{}test}\PY{o}{=}\PY{n}{tf}\PY{o}{.}\PY{n}{train}\PY{o}{.}\PY{n}{import\PYZus{}meta\PYZus{}graph}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{lenet.meta}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
             \PY{n}{saver\PYZus{}test}\PY{o}{.}\PY{n}{restore}\PY{p}{(}\PY{n}{sess}\PY{p}{,}\PY{n}{tf}\PY{o}{.}\PY{n}{train}\PY{o}{.}\PY{n}{latest\PYZus{}checkpoint}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{.}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}\PY{p}{)}
             \PY{n}{test\PYZus{}accuracy}\PY{o}{=}\PY{n}{evaluate}\PY{p}{(}\PY{n}{test\PYZus{}image\PYZus{}array}\PY{p}{,}\PY{n}{image\PYZus{}labels}\PY{p}{)}
             \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Test Accuracy=}\PY{l+s+si}{\PYZob{}:.3f\PYZcb{}}\PY{l+s+s2}{\PYZdq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{test\PYZus{}accuracy}\PY{p}{)}\PY{p}{)}
\end{Verbatim}
...
notice \texttt{{[}3,\ 0,\ 5{]}} are the corresponding indices.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}14}]:} \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} Print out the top five softmax probabilities for the predictions on the German traffic sign images found on the web. }
         \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} Feel free to use as many code cells as needed.}
\end{Verbatim}
